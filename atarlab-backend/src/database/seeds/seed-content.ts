...
const TESTIMONIALS = [
  {
    authorName: 'Aisha R.',
    quote:
      "The Royal Oud Musk attar lasted the entire day. Genuinely the best fragrance I've bought online.",
    rating: 5,
    sortOrder: 0,
  },
  {
    authorName: 'Karan M.',
    quote:
      'Packaging felt premium, and the scent is exactly as described. Will be reordering the Saffron Rose.',
    rating: 5,
    sortOrder: 1,
  },
  {
    authorName: 'Fatima S.',
    quote:
      "Finally an attar brand that doesn't feel synthetic. The oud collection is exceptional.",
    rating: 5,
    sortOrder: 2,
  },
];
...
const FAQS = [
  {
    question: "How long does an attar's fragrance last?",
    answer:
      'Our pure attars are formulated for very long longevity — most last 8–12 hours on skin.',
    sortOrder: 0,
  },
  {
    question: 'Do you offer Cash on Delivery?',
    answer:
      'Yes — COD is available at checkout alongside Razorpay for cards, UPI, and wallets.',
    sortOrder: 1,
  },
  {
    question: 'What is your return policy?',
    answer:
      'Unopened items can be returned within 7 days of delivery for a full refund.',
    sortOrder: 2,
  },
];
...
const SOCIAL_POSTS = [
  {
    imageUrl: 'https://picsum.photos/seed/insta-1/500/500',
    caption: 'Golden hour with our Oud Al Sultan.',
    sortOrder: 0,
  },
  {
    imageUrl: 'https://picsum.photos/seed/insta-2/500/500',
    caption: 'Fresh batch of Saffron Rose attar.',
    sortOrder: 1,
  },
  {
    imageUrl: 'https://picsum.photos/seed/insta-3/500/500',
    caption: 'Behind the scenes at our blending studio.',
    sortOrder: 2,
  },
  {
    imageUrl: 'https://picsum.photos/seed/insta-4/500/500',
    caption: 'Gift-wrapped and ready to ship.',
    sortOrder: 3,
  },
];
...
const BLOG_POSTS = [
  {
    ...
    excerpt:
      'How centuries-old distillation techniques still shape the fragrances we wear today.',
    content:
  ...
  },
  {
    ...
    excerpt:
      "Simple application tricks that noticeably extend an attar's longevity.",
    content:
...
export async function seedContent(dataSource: DataSource): Promise<void> {
  ...
  for (const t of TESTIMONIALS) {
    const existing = await testimonialRepo.findOne({
  ...
  for (const s of SOCIAL_POSTS) {
    const existing = await socialRepo.findOne({
      where: { imageUrl: s.imageUrl },
    });
    if (existing) continue;
