...
export class Phase3Tracking1783495651032 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_cdaeaafd545a83793ca571d3c8" ON "order_deliveries"  ("order_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "order_deliveries" ADD CONSTRAINT "FK_cdaeaafd545a83793ca571d3c89" FOREIGN KEY ("order_id") REFERENCES "orders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "order_deliveries" ADD CONSTRAINT "FK_73124c3b186d414c4b20ed711bb" FOREIGN KEY ("agent_id") REFERENCES "delivery_agents"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "notifications" ADD CONSTRAINT "FK_9a8a82462cab47c73d25f49261f" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "notifications" DROP CONSTRAINT "FK_9a8a82462cab47c73d25f49261f"`);
        await queryRunner.query(`ALTER TABLE "order_deliveries" DROP CONSTRAINT "FK_73124c3b186d414c4b20ed711bb"`);
        await queryRunner.query(`ALTER TABLE "order_deliveries" DROP CONSTRAINT "FK_cdaeaafd545a83793ca571d3c89"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9a8a82462cab47c73d25f49261"`);
        await queryRunner.query(`DROP TABLE "notifications"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_cdaeaafd545a83793ca571d3c8"`);
