...
export class AddPgTrgmSearch1783502032115 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX "IDX_categories_name_trgm" ON "categories" USING gin ("name" gin_trgm_ops)`);
    await queryRunner.query(`CREATE INDEX "IDX_brands_name_trgm" ON "brands" USING gin ("name" gin_trgm_ops)`);
  }
